...
include '../models/laporan_pemijat_model.php';
$page = null;
$page = (isset($_GET['page'])) ? $_GET['page'] : "list";
$title = ucfirst("Laporan Pemijat");
...
switch ($page) {
	...
	case 'list':
		...
		$action = "laporanpemijat.php?page=form_result&preview=1";

		include '../views/laporan_pemijat/form.php';
		...
		if(isset($_GET['preview'])){
			...
			$pijat_terlaris = get_pemijat_terlaris($date1, $date2);

			include '../views/laporan_pemijat/form_result.php';
			include '../views/laporan_pemijat/list_pemijat.php';
			//include '../views/laporan_pemijat/list_reservasi.php';
			//include '../views/report_detail/list_partner.php';
			//include '../views/laporan_penyesuaian/list_transaction.php';
		}
	...
	case 'form_result':
		...
		header("Location: laporanpemijat.php?page=list&preview=1&date=$date_default");
	break;
