...
include '../models/laporan_penyesuaian_model.php';
$page = null;
$page = (isset($_GET['page'])) ? $_GET['page'] : "list";
$title = ucfirst("Laporan Penyesuaian");
...
switch ($page) {
	...
	case 'list':
		...
		$action = "laporanpenyesuain.php?page=form_result&preview=1";

		include '../views/laporan_penyesuaian/form.php';
		...
		if(isset($_GET['preview'])){
			...
			include '../views/laporan_penyesuaian/form_result.php';
			include '../views/laporan_penyesuaian/list_item.php';
			include '../views/laporan_penyesuaian/list_reservasi.php';
	...
	case 'form_result':
		...
		header("Location: laporanpenyesuain.php?page=list&preview=1&date=$date_default");
	break;
