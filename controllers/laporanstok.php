...
include '../models/laporan_stok_model.php';
$page = null;
...
switch ($page) {
	...
	case 'list':
		...
		$action = "laporanstok.php?page=form_result&preview=1";

		include '../views/laporan_stok/form.php';
		...
		if(isset($_GET['preview'])){
			...
			include '../views/laporan_stok/form_result.php';
			include '../views/laporan_stok/list_item.php';
			include '../views/laporan_stok/list_pemasukan.php';
	...
	case 'form_result':
		...
		header("Location: laporanstok.php?page=list&preview=1&date=$date_default");
	break;
