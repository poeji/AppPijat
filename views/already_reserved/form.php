                            ...
                            <div class="box box-cokelat">
                                ...
                                <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input required type="text" name="i_name" class="form-control" placeholder="Masukkan nama ..." value="<?= $row->reserved_id ?>"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input required type="number" name="i_phone" class="form-control" placeholder="Masukkan telepon..." value="<?= $row->table_id ?>"/>
                                            </div>
                                        </div>
