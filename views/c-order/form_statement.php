<?php 
$dmember = mysql_fetch_array(mysql_query("SELECT * FROM `members` WHERE member_id = '$_GET[member]'"));
$r_statement = mysql_fetch_array(mysql_query("SELECT * FROM `statement` WHERE member_id = '$_GET[member]'"));
...
<!-- Content Header (Page header) -->
                ...
                <section class="content">
                    <div class="row">
                        ...
                        <!-- right column -->
                        <div class="col-md-12">
                        <h3>Form Statement</h3>
                            <!-- general form elements disabled -->

                          
                          <!-- <div class="title_page"> <?= $title ?></div> -->
                             <form action="c-order.php?page=simpan_statement" method="post" role="form">
                             <?php
                                            ...
                                            <div class="col-md-12"  style="background-color: #fff;">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                         <div>
                                                            <input class="untukInput1" type="text" size="105" placeholder="Nama " name="$i_name" value="<?= $dmember['member_name'] ?>" />
                                                        </div>
                                                        <br>
                                                        <div>
                                                            <input class="untukInput1" type="text" size="105" placeholder="Email" name="$i_email" value="<?= $dmember['member_email'] ?>" />
                                                        </div>
                                                        <br>
                                                        <div>
                                                            <input class="untukInput1" type="text" size="105" placeholder="Phone" name="$i_phone" value="<?= $dmember['member_phone'] ?>" />
                                                        </div>
                                                        <br>
                                                        <div>
                                                            <input class="untukInput1" type="text" size="105" placeholder="Alamat" name="$i_alamat" value="<?= $dmember['member_alamat'] ?>" />
                                                        </div><br>
