...
$qtemp = mysql_query("SELECT i.*, d.`transaction_detail_original_price`
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-top: 5;font-size:12px;">
	<tr>
		...
		?>
		<td align="right" >Cashier: <?= ucwords($usr['user_name']) ?></td>
	</tr>
	<tr>
...
<table id="" class="" width="100%">
        ...
        while ($dtemp = mysql_fetch_array($qtemp)) {
          ?>
                                  ...
                                  <?php $sub = $dtemp['item_harga_jual'] * $dtemp['transaction_detail_original_price']; ?> <?= number_format($sub) ?></td>
                                        </tr>
                                        <?php $tjual += $sub;  $no++; } ?>
                                    </tbody>
                                  </table>
                                  ...
                                  //$total_price = $tjual + $row['pijat_harga'] + $pijatharga;
                                  $sc = $total_price * 0.05;
                                  $tax = $total_price * 0.1;
...
<?php if(isset($_GET['st']) && $_GET['st'] != "temp") {  ?>
<a href="c-order.php" style="text-decoration:none" title="Order"><div class="back_to_order">Order</div></a>
<?php } ?>
