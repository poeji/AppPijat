		                      ...
		                      <tbody class="" id="data_items" class="scrollable">
									...
									<div class="col-md-6">
										...
										<table class="table my-item">
											...
											<tbody id="tbody_sales_cartshow">
													<tr>
							<td class="text-center">
							<div class="input-group input-group-sm">
							<?php /*
							<span class="input-group-btn">
							<button data-id="" class="btn btn-danger btn-sm btn-decrease-cart" type="button"><i class="fa fa-minus"></i></button>
							</span>
							<input type="text"  style="text-align:center;width:80px;" class="form-control input-sm qty" value="1">
							<span class="input-group-btn">
							<button data-id="" class="btn btn-success btn-sm btn-increase-cart" type="button"><i class="fa fa-plus"></i></button>
							</span>
							*/ ?>
							1
							</div>
							...
							<td style="text-align: right;">
											<?php /*
											<div class="btn-group">					<button type="button" data-id="'+item_id+'" class="btn btn-danger removeCart"><i class="fa fa-trash-o"></i></button>
											*/ ?>
											</div>
											</td>
							</tr>
