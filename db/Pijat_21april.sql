...
insert  into `item`(`item_id`,`item_name`,`item_hpp`,`item_margin`,`item_harga_jual`,`item_satuan`) values (1,'ITEM A',12000,3000,15000,6),(2,'ITEM B',20000,5000,30000,6),(3,'ITEM C',30000,5000,40000,5),(4,'ITEM D',20000,10000,30000,6),(31,'ITEM E',30000,5000,35000,6);
...
insert  into `item_stocks`(`item_stock_id`,`item`,`item_stock_qty`,`branch`) values (1,1,13,5),(2,4,2,5),(3,1,3,5);
...
insert  into `pijat_details`(`pijat_detail_id`,`pijat`,`item`,`satuan`,`item_qty`) values (15,1,4,8,13),(16,1,2,6,45),(17,1,2,5,121);
...
insert  into `reserved`(`reserved_id`,`name`,`phone`,`address`,`date`,`status`) values (1,'nama','081999489284','jl lontar','2017-04-19 14:15:00',0),(2,'nama 1','081931910410','nama1@gmail.com','2017-04-21 13:30:00',0);
