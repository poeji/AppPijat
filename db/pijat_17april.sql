...
insert  into `members`(`member_id`,`member_name`,`member_phone`,`member_alamat`,`member_email`) values (1,'member 1','089377282817','jl lontar','member1@gmail.com'),(2,'member 2','089374828098','jl lontar','member2@gmail.com'),(3,'member 3','082849248290','jl lontar','member3@gmail.com');
...
insert  into `pijat_details`(`pijat_detail_id`,`pijat`,`item`,`satuan`,`item_qty`) values (3,1,2,5,9),(7,2,3,5,42),(8,2,0,0,0),(10,1,2,5,45),(11,1,3,5,4);
