...
insert  into `item`(`item_id`,`item_name`,`item_hpp`,`item_margin`,`item_harga_jual`,`item_limit`,`item_satuan`) values (1,'ITEM A',12000,3000,15000,40,6),(2,'ITEM B',20000,5000,30000,12,6),(3,'ITEM C',30000,5000,40000,13,5),(4,'ITEM D',20000,10000,30000,53,6),(31,'ITEM E',30000,5000,35000,24,6),(32,'ITEM F',10000,10000,20000,23,7),(33,'ITEM G',3000,5000,35000,65,5);
...
insert  into `reserved`(`reserved_id`,`member_id`,`phone`,`address`,`date`,`hour`,`pijat`,`status`) values (25,'2','088329134198','jl lontar ','2017-04-27','11:41:00',2,0),(26,'1','089657345765','jl lontar','2017-04-27','11:00:00',1,0),(27,'3','085467234756','jl lontar','2017-04-27','02:00:00',1,0);
